...
SEASON_DATA_GAPS = os.path.abspath('Data/CSV/season_data/tipoff_and_first_score_details_{}_season.csv')
SEASON_DATA_GAPS_FILLED = os.path.abspath('Data/CSV/gaps_filled/tipoff_and_fist_score_details_{}_season.csv')
